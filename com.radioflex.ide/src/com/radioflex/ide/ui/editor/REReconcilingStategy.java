 ...
 * @author
 */
public class REReconcilingStategy implements IReconcilingStrategy,
	 ...
	 *            The ASM-Editor.
	 */
	public REReconcilingStategy(RadioFlexEditor editor) {
		this.editor = editor;

		print("R: in REReconcilingStategy Constructor");
	}
	...
	public void setDocument(IDocument document) {
		...
		print("R: in REReconcilingStategy setDocument");
	}
	...
	public final void setProgressMonitor(final IProgressMonitor monitor) {
		...
		print("R: in REReconcilingStategy setProgressMonitor");
	...
	public IDocument getDocument() {
		...
		print("R: in REReconcilingStategy getDocument");
	...
	public void initialReconcile() {
		...
		print("R: in REReconcilingStategy initialReconcile");
...
//		parse();
	...
	public void reconcile(DirtyRegion dirtyRegion, IRegion subRegion) {
		...
		print("R: in REReconcilingStategy reconcile ( incremental)");
...
//		parse();
	...
	public void reconcile(IRegion partition) {
		...
		print("R: in REReconcilingStategy reconcile ( non-incremental)");
...
//		parse();
	...
	private void parse() {
		...
		print("R: start in REReconcilingStategy parse");
...
//		});
		...
		print("R: end in REReconcilingStategy parse");
	}
}
